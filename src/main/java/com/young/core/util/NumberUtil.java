 ...
 * @Description: 数字工具类
 * @Author: Young
 * @CreateDate: 2021/3/26 3:01
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/3/26 3:01
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class NumberUtil {
    ...
    public static BigDecimal toBigDecimal(String number) {
        ...
        return StrUtil.isEmpty(number) ? BigDecimal.ZERO : new BigDecimal(number);
    }
    ...
    public static BigInteger toBigInteger(String number) {
        return StrUtil.isEmpty(number) ? BigInteger.ZERO : new BigInteger(number);
    }

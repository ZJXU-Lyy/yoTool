...
import com.young.core.lang.func.Func0;
 ...
 * @Description: 简单缓存，无超时实现，默认使用{@link WeakHashMap}实现缓存自动清理
 * @Author: Young
 * @CreateDate: 2021/3/26 0:28
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/3/26 0:28
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class SimpleCache<K, V> implements Iterable<Map.Entry<K, V>>, Serializable {
    private static final long serialVersionUID = -1970674720512060577L;
